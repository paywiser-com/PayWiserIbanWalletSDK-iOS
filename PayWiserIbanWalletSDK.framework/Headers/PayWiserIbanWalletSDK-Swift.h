...
#ifndef PAYWISERIBANWALLETSDK_SWIFT_H
#define PAYWISERIBANWALLETSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayWiserIbanWalletSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21PayWiserIbanWalletSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWiserIbanWalletSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWiserIbanWalletSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWiserIbanWalletSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWiserIbanWalletSDK)) <NSURLSessionTaskDelegate>
